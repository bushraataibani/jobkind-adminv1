              ...
              <Row>
                ...
                <Col sm={3} md={3}>
                  ...
                  >
                    ...
                    <Box>{employerJobDetails?.user_company?.company_name}</Box>
                  </Box>
                  <Box
                    sx={{
                      paddingBottom: "10px",
                  ...
                  >
                    ...
                    <Box>{employerJobDetails?.user_company?.industries_id}</Box>
                  </Box>
                  <Box
                    sx={{
                      paddingBottom: "10px",
                ...
                <Col sm={3} md={3}>
                  ...
                  >
                    ...
                    <Box> {employerJobDetails?.job_description}</Box>
                  </Box>
                </Col>
              </Row>
            </Col>
            ...
            <Box sx={{ marginBottom: "20px", width: "200px" }}>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    {employerJobDetails?.job_interviewer_detail?.recruiter_name}
                  </Box>

                  <Box sx={{ fontWeight: 500 }}>E-mail</Box>
                  <Box>
                    {employerJobDetails?.job_interviewer_detail?.contact_email}
                  </Box>
