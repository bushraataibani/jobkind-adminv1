...
export const SubscribeSlice = createSlice({
  ...
  reducers: {
    setAllSubscribe: (state, action) => {
      state.allSubscribe = action.payload;
    },
    subscribeFetched: (state, action) => {
      state.selectedSubscribe = action.payload;
    },
    removeSelectedSubscribe: (state) => {
      state.selectedSubscribe = null;
    },
